...
class _CocinaScreenState extends State<CocinaScreen>
  ...
  void initState() {
    ...
    // Animación de pulso para contadores
    ...
    // Animación del banner de nueva orden
    ...
    _bannerFade = CurvedAnimation(
        parent: _bannerCtrl, curve: Curves.easeIn);
  }
...
class _OrdenCard extends StatelessWidget {
  final Orden orden;
  final Animation<double> pulseAnim;
  const _OrdenCard({required this.orden, required this.pulseAnim});
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [
                _headerBg,
                _headerBg.withValues(alpha: 0.8)
              ]),
            ),
            child: Row(children: [
              // Emoji animado si pendiente
            ...
            Container(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: Text('Nota: ${orden.notasGenerales}',
                        style: TextStyle(
                            color: Colors.amber[800],
                            fontSize: 12,
                            fontStyle: FontStyle.italic)),
            ...
            child: Column(children: [
              ...
              orden.estado == 'lista'
                  ...
                  : ElevatedButton.icon(
                      ...
                      onPressed: () => provider.actualizarEstado(
                        orden.id,
                        orden.estado == 'pendiente'
                            ? 'en_preparacion'
                            : 'lista',
              ...
              OutlinedButton.icon(
                ...
                onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        EstadoPedidoScreen(ordenId: orden.id),
                  ),
                ),
              ),
            ]),
