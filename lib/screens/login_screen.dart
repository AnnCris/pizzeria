...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    Widget destino;
    switch (rol) {
      case 'admin':  destino = const AdminScreen();  break;
      case 'cocina': destino = const CocinaScreen(); break;
      default:       destino = const CajeroScreen();
    }
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF7B1717), Color(0xFFB03A2E),
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      _credRow('🔑 Admin',   'admin@pizzeria.com',  'admin123'),
                      _credRow('💰 Cajero',  'cajero@pizzeria.com', 'cajero123'),
                      _credRow('👨‍🍳 Cocina',  'cocina@pizzeria.com', 'cocina123'),
                    ]),
                  ),
  ...
  Widget _credRow(String rol, String email, String pass) => Padding(
        ...
        child: Row(children: [
          ...
          Text(pass, style: const TextStyle(color: Colors.white60, fontSize: 11)),
        ]),
      );
